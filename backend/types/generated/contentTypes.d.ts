...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    trasnmission: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    price_per_night: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    raiting: Schema.Attribute.Decimal;
...
export interface ApiReservReserv extends Struct.CollectionTypeSchema {
  collectionName: 'reservs';
  info: {
    description: '';
    displayName: 'flight';
    pluralName: 'reservs';
